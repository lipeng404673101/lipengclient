...
public class LogonInitWnd {
    ...
    public void Init(Object obj) {
        ...
        {
            m_BaseTransform.GetChild(0).gameObject.SetActive(true);
            m_BaseTransform.GetChild(1).gameObject.SetActive(false);
            m_BaseTransform.GetChild(2).gameObject.SetActive(false);//更改为微信登录
            m_BaseTransform.GetChild(3).gameObject.SetActive(false);//
    ...
    void OnBtnOnclickMsg(GameObject go) {
        ...
        //            Debug.Log("WECHAT");
        ////#if UNITY_EDITOR
        //            string nick_name = "haha1212";
        //            string uid = "1212121299";
        //            string image_url = "http://wx.qlogo.cn/mmopen/vi_32/gmocrdojznoaiamiajhjxowklrnfne52h86p9lhkn6som2iapa3htoiarvic0flyukpyhcswg13jfnboldmft3dylsw/0";
        //            string token = "1212121299";
        //            if (null != SceneMain.Instance)
        //                SceneMain.Instance.OnThirdLogin(uid + "," + token + "," + image_url + "," + nick_name);
