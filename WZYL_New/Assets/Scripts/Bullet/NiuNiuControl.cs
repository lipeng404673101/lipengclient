...
public class NiuNiuControl : MonoBehaviour
{
                        ...
                        if (_Buttonbtn.GetComponent<UISprite>().spriteName == "pw_check1")
                        {
                            switch (_Buttonbtn.name)
                            {
                                case "Sprite1":
                                    ...
                                    CL_Cmd_OxAdmin ncb = new CL_Cmd_OxAdmin();
                                    ncb.SetCmdType(NetCmdType.CMD_CL_OxAdmin);
                                    ...
                                    if (this.transform.Find("xianshi").transform.Find("PanlwinControl") != null)
                                    {
                                        ...
                                        foreach (Transform Buttonbtn in _PanlwinControlBack)
                                        {
                                            if (Buttonbtn.GetComponent<UISprite>().spriteName == "pw_check1")
                                            {
                                                ...
                                                GlobalHallUIMgr.Instance.ShowSystemTipsUI("成功", 2f, false);
                                            }
                                        }
                                    ...
                                    NetServices.Instance.Send<CL_Cmd_OxAdmin>(ncb);
                                    break;
                                case "Sprite2":
                                    ...
                                    CL_Cmd_OxAdmin ncb1 = new CL_Cmd_OxAdmin();
                                    ncb1.SetCmdType(NetCmdType.CMD_CL_OxAdmin);
                                    ncb1.cbReqType = (byte)(CONTROL_COMMON_INNER.RQ_RESET_CONTROL);
                                    tagOxAdminReq rep2 = new tagOxAdminReq();
                                    ncb1.cbExtendData = rep2;
                                    ncb1.dwUserIDContrl = PlayerRole.Instance.RoleInfo.RoleMe.GetUserID();
                                    NetServices.Instance.Send<CL_Cmd_OxAdmin>(ncb1);
                                    break;
                                case "Sprite3":
                                    ...
                                    CL_Cmd_OxAdmin ncb2 = new CL_Cmd_OxAdmin();
                                    ncb2.SetCmdType(NetCmdType.CMD_CL_OxAdmin);
                                    ncb2.cbReqType = (byte)(CONTROL_COMMON_INNER.RQ_PRINT_SYN);
                                    tagOxAdminReq rep3 = new tagOxAdminReq();
                                    ncb2.cbExtendData = rep3;
                                    ncb2.dwUserIDContrl = PlayerRole.Instance.RoleInfo.RoleMe.GetUserID();
                                    NetServices.Instance.Send<CL_Cmd_OxAdmin>(ncb2);
                                    break;
                                case "Sprite4":
                                    ...
                                    CL_Cmd_OxAdmin ncb3 = new CL_Cmd_OxAdmin();
                                    ncb3.SetCmdType(NetCmdType.CMD_CL_OxAdmin);
                                    ncb3.cbReqType = (byte)(CONTROL_COMMON_INNER.RQ_QUERY_NAMES);
                                    tagOxAdminReq rep1 = new tagOxAdminReq();
                                    ncb3.cbExtendData = rep1;
                                    ncb3.dwUserIDContrl = PlayerRole.Instance.RoleInfo.RoleMe.GetUserID();
                                    NetServices.Instance.Send<CL_Cmd_OxAdmin>(ncb3);
                                    break;
                                case "Sprite5":
                                    ...
                                    CL_Cmd_OxAdmin ncb4 = new CL_Cmd_OxAdmin();
                                    ncb4.SetCmdType(NetCmdType.CMD_CL_OxAdmin);
                                    ncb4.cbReqType = (byte)(CONTROL_COMMON_INNER.RQ_QUERY_PLAYERJETTON);
                                    tagOxAdminReq rep4 = new tagOxAdminReq();
                                    ncb4.cbExtendData = rep4;
                                    ncb4.dwUserIDContrl = PlayerRole.Instance.RoleInfo.RoleMe.GetUserID();
                                    NetServices.Instance.Send<CL_Cmd_OxAdmin>(ncb4);
                                    break;
                                case "Sprite6":
                                    ...
                                    CL_Cmd_OxAdmin ncb5 = new CL_Cmd_OxAdmin();
                                    ncb5.SetCmdType(NetCmdType.CMD_CL_OxAdmin);
                                    ncb5.cbReqType = (byte)(CONTROL_COMMON_INNER.RQ_QUERY_ALLJETTON);
                                    tagOxAdminReq rep5 = new tagOxAdminReq();
                                    ncb5.cbExtendData = rep5;
                                    ncb5.dwUserIDContrl = PlayerRole.Instance.RoleInfo.RoleMe.GetUserID();
                                    NetServices.Instance.Send<CL_Cmd_OxAdmin>(ncb5);
                                    break;
                            }
                        }
                    }
