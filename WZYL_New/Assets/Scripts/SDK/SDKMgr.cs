...
public class SDKMgr : Singleton<SDKMgr>, ISDKCallback
{
    ...
    //cn.sharesdk.unity3d.ShareSDK   ssdk      =new cn.sharesdk.unity3d.ShareSDK();
    ...
    public void LoginCallback(SDKLoginResult result)
    {
        ...
        else
        {
            ...
            if (null != SceneMain.Instance)
                SceneMain.Instance.OnThirdLogin(result.UID + "," + result.Token + "," + result.ImageUrl + "," + result.UserName);
        }
    }
