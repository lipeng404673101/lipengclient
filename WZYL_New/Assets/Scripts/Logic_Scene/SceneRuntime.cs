...
class SceneRuntime
{
    ...
    {
        return !bMyself ?  Instance.IndxMapping[seat] : (byte)0;//机器人和玩家
    }
...
//        Instance.GlodPosMapping[4] = new Vector3(-0.580940962f, -0.8208333f, 0.0f);//金币位置的特效
		Instance.GlodPosMapping[4] = new Vector3(-0.46f, -0.9f, 0.0f);//修改后的位置
		Instance.GlodPosMapping[5] = new Vector3(0.96f, -0.9f, 0.0f);//修改后的位置
