...
class RoleRelationRequest
{
    ...
    public bool HandleCmd(NetCmdBase obj)
    {
        switch (obj.GetCmdType())
        {
            ...
            case NetCmdType.CMD_LC_AnimalAdminContrlBack:
                return OnHandleAnimalAdminContrlBack(obj);
            case NetCmdType.CMD_LC_AnimalAdminQueryNameContrl:
                return OnHandleAnimalAdminQueryNameContrl(obj);
            case NetCmdType.CMD_LC_AnimalAdminQueryAllJettonContrl:
                return OnHandleAnimalAdminQueryAllJettonContrl(obj);
            case NetCmdType.CMD_LC_AnimalAdminQueryPlayerJettonContrl:
                return OnHandleAnimalAdminQueryPlayerJettonContrl(obj);
        }
        return false;
    }
    ...
    bool OnHandleAnimalAdminContrlBack(NetCmdBase obj)
    {
        LC_Cmd_AnimalAdminContrlBack ncb = (LC_Cmd_AnimalAdminContrlBack)obj;
        Debug.Log(ncb.dwUserIDContrl);
        return true;
    }
    bool OnHandleAnimalAdminQueryNameContrl(NetCmdBase obj)
    {
        LC_Cmd_AnimalAdminQueryNameContrl ncb = (LC_Cmd_AnimalAdminQueryNameContrl)obj;
        Debug.Log(ncb.dwUserIDContrl);
        return true;
    }
    bool OnHandleAnimalAdminQueryAllJettonContrl(NetCmdBase obj)
    {
        LC_Cmd_AnimalAdminQueryAllJettonContrl ncb = (LC_Cmd_AnimalAdminQueryAllJettonContrl)obj;
        Debug.Log(ncb.dwUserIDContrl);
        return true;
    }
    bool OnHandleAnimalAdminQueryPlayerJettonContrl(NetCmdBase obj)
    {
        LC_Cmd_AnimalAdminQueryPlayerJettonContrl ncb = (LC_Cmd_AnimalAdminQueryPlayerJettonContrl)obj;
        Debug.Log(ncb.dwUserIDContrl);
        return true;
    }
}