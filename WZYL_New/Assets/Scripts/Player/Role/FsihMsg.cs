...
public class FishDataInfo {
    ...
    public const int MAC_LENGTH = 18;
...
public class LC_Cmd_TableChangeRoleGlobeDown : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 dwDestUserID;
    [TypeInfo(1)]
    public Int32 dwGlobelSum;
...
public class LC_Cmd_ChangeRoleGlobeDown : NetCmdBase {
    //[TypeInfo(0)]
    //public UInt32 dwUserID;
    [TypeInfo(0)]
    public Int32 dwGlobeNum;
...
public class Cl_Cmd_ShopGoldItem : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 dwUserID;
    [TypeInfo(1)]
    public UInt32 ChangeGlobel;
    [TypeInfo(2, FishDataInfo.MAX_NAME_LENTH + 1)]
    public string UseName;
    [TypeInfo(3, FishDataInfo.MaxMailContexeLength + 1)]
    public string Addres;
    [TypeInfo(4, FishDataInfo.RMB_OnceOnlyID_Length + 1)]
...
public class CL_Cmd_ChangeaNickName : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 RankValue;
    [TypeInfo(1, FishDataInfo.MAX_CHARM_ITEMSUM + 1)]
    public string MachineCode;
}
public class CL_Cmd_ResetRolePassword : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 RankValue;
    [TypeInfo(1)]
    public UInt32 Passworldone;
    [TypeInfo(2)]
    public UInt32 Passworldtwo;
    [TypeInfo(3)]
    public UInt32 Passworldthree;
}
public class CL_Cmd_KickUserByID : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 UserID;
    [TypeInfo(1)]
    public UInt32 ClientID;
    [TypeInfo(2)]
    public UInt32 FreezeMin;
}
/// <summary>
/// 充值消息码定义   添加
/// </summary>
public class CL_Cmd_QRoleDaili : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 UserID;
...
/// 服务器返回的消息信息
/// </summary>
public class LC_Cmd_GetRoleDaili : NetCmdBase {
    [TypeInfo(1, 128)]
    public string NumName1;
    [TypeInfo(2, 128)]
    public string NumName2;
    [TypeInfo(3, 128)]
    public string NumName3;
    [TypeInfo(4, 128)]
    public string NumName4;
    [TypeInfo(5, 128)]
    public string NumName5;
    [TypeInfo(6, 128)]
    public string NumName6;
    [TypeInfo(7, 128)]
    public string NumName7;
    [TypeInfo(8, 128)]
    public string NumName8;
    //[TypeInfo(9, 128)]
    //public string NumName9;
    //[TypeInfo(10, 128)]
    //public string NumName10;
}

public class CL_Cmd_ChangeUserGold : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 UserIDself;
    [TypeInfo(1)]
    public UInt32 UserID;
    [TypeInfo(2)]
    public UInt32 GlobalNum;
    [TypeInfo(3)]
    public bool bIsZongDai;
    [TypeInfo(4)]
    public bool bIsScoreDown;//是否是减少金币
}
public class CL_Cmd_ChangeTablePool : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 TableID;
    [TypeInfo(1)]
    public UInt64 nValue;
}

public class CL_Cmd_CheckClientInfo : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 RankValue;
    [TypeInfo(1, FishDataInfo.MAC_LENGTH)]
...
public class LC_Cmd_CheckClientInfo : NetCmdBase {
    [TypeInfo(0)]
    public bool Result;
    [TypeInfo(1)]
    public UInt32 dwUserID;
    [TypeInfo(2)]
    public Byte BackeNum;
}
public class CL_Cmd_SendMsgToAllGame : NetCmdBase//发布公告
{
    [TypeInfo(0)]
    public UInt32 Param;
    [TypeInfo(1)]
...
public class LC_Cmd_KickUserResult : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 dwUserID;
    [TypeInfo(1)]
    public UInt32 ClientID;
...
public class CL_Cmd_ReloadConfig : NetCmdBase {

}
public class CL_Cmd_HandleGailv : NetCmdBase {
    [TypeInfo(0)]
    public float RNumrateF;
    [TypeInfo(1)]
    public float RNumrateS;
    [TypeInfo(2)]
    public float RNumrateT;
    [TypeInfo(3)]
    public float OrderNumber;
}
public class CL_Cmd_CheckClientDailiBond : NetCmdBase//检测玩家绑定
{
    [TypeInfo(0)]
    public UInt32 dwUserID;
    [TypeInfo(1)]
    public UInt32 dwOtherUserID;

}
public class CL_Cmd_ClientDailiBond : NetCmdBase//检测玩家绑定代理
{
    [TypeInfo(0)]
    public UInt32 dwUserID;
    [TypeInfo(1)]
...
public class CL_Cmd_HandleEntityItem : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 ID;
    [TypeInfo(1)]
    public UInt32 ClientID;
...
public class LC_Cmd_HandleEntityItem : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 ClientID;
    [TypeInfo(1)]
    public bool Result;
}
public class CL_Cmd_FreezeAccount : NetCmdBase {

}
public class CL_Cmd_SendSystemEmail : NetCmdBase {

}
public class CL_Cmd_QueryOnlineUserInfo : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 UserId;
    [TypeInfo(1)]
    public UInt32 NULL;
}
public class LC_Cmd_QueryOnlineUserInfo : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 UserId;
    [TypeInfo(1)]
    public bool Result;
...
public class CL_Cmd_ChangeParticularStates : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 dwUserID;
    [TypeInfo(1)]
    public UInt32 ParticularStates;
...
public class LC_Cmd_ChangeParticularStates : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 dwUserID;
    [TypeInfo(1)]
    public UInt32 ParticularStates;
...
public class LC_Cmd_CenterInfo : NetCmdBase {

}
public class LC_Cmd_GameInfo : NetCmdBase {

}
public class LC_Cmd_LogonInfo : NetCmdBase {

}
public class LC_Cmd_DBInfod : NetCmdBase {

}
public class LC_Cmd_RankInfo : NetCmdBase {

}
public class LC_Cmd_FTPInfo : NetCmdBase {

}
public class LC_Cmd_OperateInfo : NetCmdBase {

}
public class LC_Cmd_MiNiGameInfo : NetCmdBase {

}
public class CL_Cmd_QueryFishPool : NetCmdBase//查询库存命令
{
    [TypeInfo(0)]
    public UInt32 ClientID;
    [TypeInfo(1)]
...
//public class LC_CMD_QueryFishPoolResult : NetCmdBase
//{
//    [TypeInfo(0)]
//    public UInt32 ClientID;
//    [TypeInfo(1)]
...
//    long[] lTableTypePool;
//}
public class CL_Cmd_HandleTablePoolGailv : NetCmdBase {
    [TypeInfo(0)]
    public byte TableID;//桌子的id 0 1 2 3 
    [TypeInfo(1)]
    public double nValue;//修改的库存值

}
public class TableTypePool {
    [TypeInfo(0)]
    public bool bopen;
    [TypeInfo(1)]
    public UInt64 npool;
...
public class LC_Cmd_QueryFishPoolResult : NetCmdBase {
    ...
    public Byte byServerid;
    [TypeInfo(2, 5)]
    public double[] lTableTypePool1;

}
public class LC_Cmd_QueryOnlineUserInfoRol : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 UserId;
    [TypeInfo(1)]
    public bool Result;
...
public class LC_Cmd_QueryBlackListResultRol : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 ClientID;
    [TypeInfo(1)]
    public Byte byServerid;
...
public class LC_Cmd_SetBlackListResultRol : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 ClientID;
    [TypeInfo(1)]
    public Byte byServerid;
...
public class LC_Cmd_CheckRoleUserDailiBond : NetCmdBase//返回检测代理绑定结果
{
    [TypeInfo(0)]
    public bool Result;
    [TypeInfo(1)]
...
public class LC_Cmd_RoleUserDailiBondResult : NetCmdBase//返回检测代理结果
{
    [TypeInfo(0)]
    public bool Result;
    [TypeInfo(1)]
...
public class CL_Cmd_QueryBlackList : NetCmdBase {

}
public class LC_Cmd_QueryBlackListResult : NetCmdBase {

}
public class CL_Cmd_SetBlackList : NetCmdBase {

}
public class LC_Cmd_SetBlackListResult : NetCmdBase {

}
public class tagOxAdminReq {
    [TypeInfo(0)]
    public Byte m_cbExcuteTimes;
    [TypeInfo(1)]
    public Byte m_cbControlStyle;
    [TypeInfo(2, 4)]
    public bool[] m_bWinArea;
}
public class CL_Cmd_OxAdmin : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 ClientID;
    [TypeInfo(1)]
    public Byte cbReqType;
    [TypeInfo(2)]
    public UInt32 dwUserID;//被控制玩家的ID
    [TypeInfo(3)]
    public UInt32 dwUserIDContrl;////玩家id  xin新添参数  控制玩家的玩家ID
    [TypeInfo(4)]
    public tagOxAdminReq cbExtendData;
}
public class LC_Cmd_OxAdmin : NetCmdBase {

}
public class LC_Cmd_OxAdminQueryName : NetCmdBase {

}
public class LC_Cmd_OxAdminQueryAllJetton : NetCmdBase {

}
public class LC_Cmd_OxAdminQueryPlayerJetton : NetCmdBase {

}
public class tagAnimalAdminReq {
    [TypeInfo(0)]
    public Byte m_cbExcuteTimes;//执行次数
    [TypeInfo(1)]
    public Byte m_cbControlStyle;//控制方式
    [TypeInfo(2)]
    public Byte m_cbarea;//控制区域
}
public class CL_Cmd_AnimalAdmin : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 ClientID;
    [TypeInfo(1)]
    public Byte cbReqType;
    [TypeInfo(2)]
    public UInt32 dwUserID; //新添参数  玩家id
    [TypeInfo(3)]
    public UInt32 dwUserIDContrl;//玩家id  xin新添参数  控制玩家的
    [TypeInfo(4)]
    public tagAnimalAdminReq cbExtendData;//修改
}
public class LC_Cmd_AnimalAdminContrlBack : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 ClientID;
    [TypeInfo(1)]
...
public class LC_Cmd_AnimalAdminQueryNameContrl : NetCmdBase {
...
public class LC_Cmd_AnimalAdminQueryAllJettonContrl : NetCmdBase {
    ...
    public UInt32 dwUserIDContrl;//玩家id  xin新添参数  控制玩家的
    [TypeInfo(2)]
    public UInt64 nStock;
    [TypeInfo(3, 12)]
    public UInt64 nJetton;
}
public class LC_Cmd_AnimalAdminQueryPlayerJettonContrl : NetCmdBase {

    [TypeInfo(0)]
    public UInt32 ClientID;
    [TypeInfo(1)]
    public UInt32 dwUserID;//其它玩家的id
    [TypeInfo(2)]
    public UInt32 dwUserIDContrl;//玩家id  xin新添参数  控制玩家的
    [TypeInfo(3, 9)]
    public string name;
    [TypeInfo(4, 12)]
    public UInt32 dwJetton;
}
public class LC_Cmd_AnimalAdmin : NetCmdBase {

}
public class LC_Cmd_AnimalAdminQueryName : NetCmdBase {

}
public class LC_Cmd_AnimalAdminQueryAllJetton : NetCmdBase {

}
public class LC_Cmd_AnimalAdminQueryPlayerJetton : NetCmdBase {

}
public class CL_Cmd_CarAdmin : NetCmdBase {

}
public class LC_Cmd_CarAdmin : NetCmdBase {

}
public class LC_Cmd_CarAdminQueryName : NetCmdBase {

}
public class LC_Cmd_CarAdminQueryAllJetton : NetCmdBase {

}
public class LC_Cmd_ChangeRoleGlobeSuccess : NetCmdBase {
    [TypeInfo(0)]
    public UInt32 dwUserID;
    [TypeInfo(1)]
    public int dwGlobeNum;
    [TypeInfo(2)]
    public bool bIsSuccess;
    [TypeInfo(3)]
    public bool bIsUserOnline;
    [TypeInfo(4)]
    public bool bIslowuserGold;
}

public class LC_Cmd_CarAdminQueryPlayerJetton : NetCmdBase {
