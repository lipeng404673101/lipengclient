    ...
    public static void HandleMsg(tagMsgEventBase pBase) {
        ...
        switch (pBase.GetMsgEventType) {
            ...
            case MsgEventType.MET_Role_VipChange: {
                ...
                break;
            //case MsgEventType.MET_Role_LevelChange://更新
            //    { 
            //        //玩家自己等级变化的时候
            ...
            case MsgEventType.MET_Achievement_Change: {
                    if (HallRunTimeInfo.Instance_UI != null) { HallRunTimeInfo.Instance_UI.m_loginUi.UpdateAchievementDate(); }
                }
                break;
            ...
            case MsgEventType.MET_Rank_XmlChange: {
                    if (HallRunTimeInfo.Instance_UI != null) { HallRunTimeInfo.Instance_UI.m_loginUi.UpdateInfomationTaskContent(); }
                }
                break;
            ...
            case MsgEventType.MET_Shop_ShopResult: {
                    if (ShopRuntime.Instance != null) {
                        ...
                        if (pShop.Result) {
                            ...
                            GlobalHallUIMgr.Instance.ShowSystemTipsUI("恭喜您兑换成功", 0.5f, false);
                        }
                        else
                            GlobalHallUIMgr.Instance.ShowSystemTipsUI("很可惜您的兑换失败", 0.5f, false);
                        ShopRuntime.ShopUI.UpdateKnapsackDate();
                    }
                }
                break;
            ...
            case MsgEventType.MET_Table_Join: {
                    ...
                    //根据错误的码  我们进行处理
                    HallLoginUI_Room theng = new HallLoginUI_Room();
                    tagJoinTableEvent pJoin = (tagJoinTableEvent)pBase;
                    double gold = (PlayerRole.Instance.TableManager.GetTableErrorParam(pJoin.TableID, pJoin.Error)) / 1000;
            ...
            case MsgEventType.MET_Car_Join: {
                    ...
                    if (GlobalHallUIMgr.Instance.GetCarLogicMgr()) {
                        GlobalHallUIMgr.Instance.EnterGameCar(pEvent.TableUpdateSec,pEvent.TableStates,pEvent.TableGlobelInfo,pEvent.TableBankerInfo,
                        pEvent.TableWriteBankerList,
            ...
            case MsgEventType.MET_Car_StatesChange: {
                    ...
                    if (GlobalHallUIMgr.Instance.GetCarLogicMgr()) {
                        GlobalHallUIMgr.Instance.CarStatusChange(pEvent.TableStates,pEvent.TableGlobelInfo,pEvent.OldVipSeatInfo,pEvent.TableVipSeatInfo,
                        pEvent.TableWriteBankerList,
                        pEvent.TableBankerUserInfo,
                        pEvent.TableGameLog,
                        pEvent.TableResult);
