...
public class HallLoginUI_MatchGuide : BaseWnd
{
	...
	public void InitObj()
    {
        m_Obj = ResManager.Instance.LoadObject("Ef_JingsaiYindao", "HallRes/Prefab/Effect/UIJingsaijiesuo/", ResType.HallRes);//竞赛引导
    }
    void Init()
    {
        ...
        m_BaseWndObject.SetActive(false);//仅显示
      ...
      // WndManager.Instance.Push(m_BaseTrans);//这是原来的。
       WndManager.Instance.Pop(m_BaseTrans);//后加的
