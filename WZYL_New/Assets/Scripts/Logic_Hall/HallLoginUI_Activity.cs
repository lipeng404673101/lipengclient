...
public class HallLoginUI_Activity : HallLoginUI_BaseWind
{
   // GameObject hallmian;
    ...
    {
        UnityEngine.Object obj = ResManager.Instance.LoadObject("ActivityWnd", "GlobalRes/Activity/", ResType.GlobalRes); //ActivityWnd
        Obj = obj;
    ...
    public void InitGameObject()
    {
        ...
        if (WindObj == null)
        {
            ...
            BaseTranF.SetParent(SceneObjMgr.Instance.UIPanelTransform, false );//弹出式窗口？
            WindObj.SetActive(true );
            WndManager.Instance.Push(WindObj);//禁用大部分按钮？
            /***以下为自己添加的****/
            WndManager.Instance.Pop(WindObj);//解除大部分按钮的禁用？
           HallRunTimeInfo.Login_UI.ChangeHallWind(HallLogicUIStatue.Hall_State.Hall_Mian);//显示“开始游戏” 报错
        }
    ...
    void SetInitalWnd()
    {
        ...
        //    m_ActivityType = ActivityType.LevelActivity_UI;//更新
        else if (bPayReward)
    ...
    public void Update(float dTime)
    {
        ...
        switch (m_ActivityType)
        {
            ...
            //    m_ActivityLevelWnd.Update(dTime);//更新
            //    break;
    ...
    public void UpdateSingleActivityData(byte ActivityID)
    {
        if (WindObj == null || WindObj.activeSelf != true)
            return;
        //if (ActivityID == m_ActivityLevelWnd.ActivityID)//更新
        //{
    ...
    public void SetActivityRewardEft(byte ActivityID, byte NodeID, ushort RewardID)
    {
        ...
        //{
        //    m_ActivityLevelWnd.SetActivityRewardEft(ActivityID, NodeID);//更新
        //    IsLevelReward();
        //}
        else if (ActivityID == m_ActivityPayWnd.ActivityID)
        {
    ...
    void OnClickCloseWind(GameObject go)
    {
        ...
        //m_ActivityLevelWnd.SaveSubmrainePos();//更新
    }
        ...
        switch (Tag)
        {
            case (byte)ActivityType.SignIn_UI:         //签到按纽   
               ...
               // m_SignInWnd.SetParent(this);
                ...
                break;
            //case (byte)ActivityType.LevelActivity_UI:         //等级礼包 //更新
    ...
    void UpdateWndUIData(ActivityType statue)
    {
        ...
        switch (statue)
        {
            case ActivityType.SignIn_UI:
                break;
            //case ActivityType.LevelActivity_UI://更新
            //    m_ActivityLevelWnd.UpdateActivityLevelData();
            //    break;
            case ActivityType.PayActivity_UI:
                m_ActivityPayWnd.UpdatePayActivityData();
