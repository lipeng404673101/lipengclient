...
public class GlobalNotice : BaseWnd
{
    ...
    void Init()
    {
        ...
        m_BaseWndObject.transform.localPosition = new Vector3(70f, 150f, 0f);
        //m_BaseWndObject.transform.localPosition = new Vector3(285f, 150f, 0f);
        //if (GameObject.Find("SceneUIRoot").transform.Find("ParentPanel").transform.Find("HallRoomWind(Clone)") != null)
        //{
        //    Debug.Log("room is choose card1");
        //    m_BaseWndObject.transform.localPosition = new Vector3(285f, 150f, 0f);
        //}

        //if (GameObject.Find("SceneUIRoot").transform.Find("ParentPanel").transform.Find("BulletLauncher0(Clone)") != null)
        //{
        //    Debug.Log("room is choose card2");
        //    m_BaseWndObject.transform.localPosition = new Vector3(70f, 150f, 0f);
        //}

        //if (GameObject.Find("SceneUIRoot").transform.Find("ParentPanel").transform.Find("HeadWind(Clone)") == null)
        //{

        //    m_BaseWndObject.transform.localPosition = new Vector3(248f, 180f, 0f);
        //}
