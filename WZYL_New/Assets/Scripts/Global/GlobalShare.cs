...
public class  GameShare
{
    ...
    void InIt()
    {
        ...
        //设置静态信息
        {
            ...
            //头像
            m_avatar.gameObject.GetComponent<SpriteUrl>().SetAsyncImage(PlayerRole.Instance.RoleInfo.RoleMe.GetImageUrl());
        }
    ...
    public void ShowGold(uint nGold, uint nTime)
    {
        ...
        InIt();
        double gold = (double)(nGold / 1000f);
        m_labelWin.text = (string.Format("{0:N3}", gold)).ToString().Replace(",", ""); 
