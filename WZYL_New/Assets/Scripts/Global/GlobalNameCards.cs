...
{
    public static GlobalNameCards instance;
    bool                m_bMysSelf;
    uint                m_PlayerID;
    ...
    void SetCardsInfo()
    {
        ...
        if (m_bMysSelf)
        {
            ...
            m_CardsInfo.m_UIFace.gameObject.GetComponent<SpriteUrl>().SetAsyncImage(PlayerRole.Instance.RoleInfo.RoleMe.GetImageUrl());
        ...
        else if (m_ParentType == CardsParentUIType.Scene_Head)
        {
            ...
            //头像
            m_CardsInfo.m_UIFace.gameObject.GetComponent<SpriteUrl>().SetAsyncImage(PlayerRole.Instance.TableManager.GetTableRole(m_PlayerID).GetImageUrl());
    ...
    public void UpdateOtherQueryUserCardsInfo(QueryRole pQuery)
    {
       ...
       // m_CardsInfo.m_UICardsInfo[3].text = PlayerRole.Instance.CharmManager.GetCharmValue(pQuery.GetCharmInfo()).ToString();
        ...
        m_CardsInfo.m_UIFace.GetComponent<SpriteUrl>().SetAsyncImage(pQuery.GetImageUrl());
    }
