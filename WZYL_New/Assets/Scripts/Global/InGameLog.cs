...
public class InGameLog : MonoBehaviour {
	...
	void OnGUI()
	{
		...
		if( GUILayout.Button( "Clear" , barStyle , GUILayout.Width(100), GUILayout.Height(50)))
		{
			clear();
		}
		...
		if( GUILayout.Button( "  Hide  " ,barStyle, GUILayout.Width(100), GUILayout.Height(50)))
		{
			show = false;
		}
