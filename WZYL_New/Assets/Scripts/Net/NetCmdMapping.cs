...
public enum LOCAL_SubControl
{
    CL_Sub_CheckClientInfo = 1,//外部登陆到Control
    LC_Sub_CheckClientInfo = 2,

    //CL_GetCenterPlayerSum = 3,//获取服务器端在线人数
    //LC_GetCenterPlayerSum = 4,

    CL_Sub_SendMsgToAllGame = 5,//发送全服公告

    //CL_ResetNoticeConfig= 6,

    CL_Sub_KickUserByID = 7,//剔除玩家
    LC_Sub_KickUserResult = 8,

    CL_Sub_ReloadConfig = 9,//重新加载配置文件

    CL_Sub_HandleEntityItem = 10,//实体物品发货
    LC_Sub_HandleEntityItem = 11,

    CL_Sub_ResetRolePassword = 12,//重置用户的密码
    CL_Sub_FreezeAccount = 13,//冻结玩家 

    CL_Sub_SendSystemEmail = 14,//发送系统邮件

    CL_Sub_ChangeaNickName = 15,//修改名称

    CL_Sub_QueryOnlineUserInfo = 16,//在线玩家列表
    LC_Sub_QueryOnlineUserInfo = 17,

    CL_Sub_ChangeParticularStates = 18,
    LC_Sub_ChangeParticularStates = 19,

    //控制服务器数据统计
    LC_Sub_CenterInfo = 20,
    LC_Sub_GameInfo = 21,
    LC_Sub_LogonInfo = 22,
    LC_Sub_DBInfo = 23,
    LC_Sub_RankInfo = 24,
    LC_Sub_FTPInfo = 25,
    LC_Sub_OperateInfo = 26,
    LC_Sub_MiNiGameInfo = 27,
    CL_Sub_QueryFishPool = 28,//查询库存

    LC_Sub_QueryFishPoolResult = 29,//查询库存结果
    CL_Sub_QueryBlackList = 30,//查询黑名单
    LC_Sub_QueryBlackListResult = 31,//查询黑名单结果
    CL_Sub_SetBlackList = 32,//设置黑名单
    LC_Sub_SetBlackListResult = 33,//设置黑名单结果
    CL_Sub_OxAdmin = 40,//牛牛控制
    LC_Sub_OxAdmin = 41,//牛牛控制
    LC_Sub_OxAdminQueryName = 42,//查询名字
    LC_Sub_OxAdminQueryAllJetton = 43,//查询所有
    LC_Sub_OxAdminQueryPlayerJetton = 44,//

    CL_Sub_AnimalAdmin = 45,////舞会控制
    LC_Sub_AnimalAdmin = 46,//
    LC_Sub_AnimalAdminQueryName = 47,//查询名字
    LC_Sub_AnimalAdminQueryAllJetton = 48,//查询所有
    LC_Sub_AnimalAdminQueryPlayerJetton = 49,//

    CL_Sub_CarAdmin = 50,////车控制
    LC_Sub_CarAdmin = 51,//
    LC_Sub_CarAdminQueryName = 52,//查询名字
    LC_Sub_CarAdminQueryAllJetton = 53,//查询所有
    LC_Sub_CarAdminQueryPlayerJetton = 54,//
    CL_Sub_ChangeUserGold = 55,
    CL_Sub_ChangeTablePool = 57,
    CL_Sub_HandleGailv = 58,
    CL_Sub_CheckClientDailiBond=59,
    CL_Sub_ClientDailiBond = 60,


    CL_QRoleDaili = 101,//请求信息
...
public enum TABLE_SubCmd
{
    ...
    LC_Sub_TableChangeRoleGlobeDown=32,//减少金币
...
public enum CONTROL_COMMON_INNER
{
    CS_BANKER_LOSE = 1,
    CS_BANKER_WIN = 2,
    CS_BET_AREA = 3,

    RQ_SET_WIN_AREA = 4,//准备控制连接3
    RQ_RESET_CONTROL = 5,//取消操控
    RQ_PRINT_SYN = 6,//暂时不用管
    RQ_QUERY_NAMES = 7,  //查id
    RQ_QUERY_PLAYERJETTON = 8,  //下注传入userID
    RQ_QUERY_ALLJETTON = 9, //总下注 什么都不用传入
...
public enum Role_SubCmd
{
    ...
    LC_Sub_ChangeRoleGlobeDown=89,
    LC_Sub_ChangeRoleUserDailito = 90,
    LC_Sub_ChangeRoleGlobeSuccess = 91,
    LC_Sub_QueryFishPoolResult = 92,
    LC_Sub_QueryOnlineUserInfoRol = 93,
    LC_Sub_QueryBlackListResultRol = 94,
    LC_Sub_SetBlackListResultRol = 95,
    LC_Sub_CheckRoleUserDailiBond = 98,
    LC_Sub_RoleUserDailiBondResult = 99,
...
public enum Dial_SubCmd
{
    ...
    LC_Sub_AnimalAdminContrlBack = 69,//
    LC_Sub_AnimalAdminQueryNameContrl = 70,//查询名字
    LC_Sub_AnimalAdminQueryAllJettonContrl = 71,//查询所有
    LC_Sub_AnimalAdminQueryPlayerJettonContrl = 72,//
}
...
public enum NetCmdType
{
    ...
    CMD_LC_TableChangeRoleGlobeDown         = (int)(MainCmdType.CMD_MAIN_Table << 8) | (int)(TABLE_SubCmd.LC_Sub_TableChangeRoleGlobeDown),
   ...
   //CMD_LC_GetUserMailFinish            = (int)(MainCmdType.CMD_MAIN_Mail << 8) | (int)(Mail_SubCmd.LC_Sub_GetUserMailFinish),
    ...
    CMD_LC_ChangeRoleGlobeDown              = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_ChangeRoleGlobeDown),
    CMD_LC_ChangeRoleUserDailito        = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_ChangeRoleUserDailito),
    CMD_LC_ChangeRoleGlobeSuccess       = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_ChangeRoleGlobeSuccess),

    CMD_LC_GetRoleDaili                  = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_GetRoleDaili),
   ...
   // CMD_LC_GetRankInfoFinish            = (int)(MainCmdType.CMD_MAIN_Rank << 8) | (int)(Rank_SubCmd.LC_Sub_GetRankInfoFinish),
    ...
    //控制
    CMD_CL_CheckClientInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_CheckClientInfo),


    CMD_LC_CheckClientInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_CheckClientInfo),

    CMD_CL_SendMsgToAllGame = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_SendMsgToAllGame),
    CMD_CL_KickUserByID = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_KickUserByID),
    CMD_LC_KickUserResult = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_KickUserResult),
    CMD_CL_ReloadConfig = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_ReloadConfig),
    CMD_CL_HandleGailv = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_HandleGailv),
    CMD_CL_CheckClientDailiBond = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_CheckClientDailiBond),
    CMD_CL_ClientDailiBond = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_ClientDailiBond),
    CMD_CL_HandleEntityItem = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_HandleEntityItem),
    CMD_LC_HandleEntityItem = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_HandleEntityItem),
    CMD_CL_ResetRolePassword = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_ResetRolePassword),
    CMD_CL_FreezeAccount = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_FreezeAccount),
    CMD_CL_SendSystemEmail = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_SendSystemEmail),
    CMD_CL_ChangeaNickName = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_ChangeaNickName),
    CMD_CL_QueryOnlineUserInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_QueryOnlineUserInfo),
    CMD_LC_QueryOnlineUserInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_QueryOnlineUserInfo),
    CMD_CL_ChangeParticularStates = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_ChangeParticularStates),
    CMD_LC_ChangeParticularStates = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_ChangeParticularStates),
    CMD_LC_CenterInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_CenterInfo),
    CMD_LC_GameInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_GameInfo),
    CMD_LC_LogonInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_LogonInfo),
    CMD_LC_DBInfod = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_DBInfo),
    CMD_LC_RankInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_RankInfo),
    CMD_LC_FTPInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_FTPInfo),
    CMD_LC_OperateInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_OperateInfo),
    CMD_LC_MiNiGameInfo = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_MiNiGameInfo),
    CMD_CL_QueryFishPool = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_QueryFishPool),
    //更新
    Cmd_CL_HandleTablePoolGailv = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_ChangeTablePool),

    //  CMD_LC_QueryFishPoolResult = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_QueryFishPoolResult),
    CMD_CL_QueryBlackList = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_QueryBlackList),
    CMD_LC_QueryBlackListResult = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_QueryBlackListResult),
    CMD_CL_SetBlackList = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_SetBlackList),
    CMD_LC_SetBlackListResult = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_SetBlackListResult),
    CMD_CL_OxAdmin = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_OxAdmin),
    CMD_LC_OxAdmin = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_OxAdmin),
    CMD_LC_OxAdminQueryName = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_OxAdminQueryName),
    CMD_LC_OxAdminQueryAllJetton = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_OxAdminQueryAllJetton),
    CMD_LC_OxAdminQueryPlayerJetton = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_OxAdminQueryPlayerJetton),
    CMD_CL_AnimalAdmin = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_AnimalAdmin),
    CMD_LC_AnimalAdmin = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_AnimalAdmin),
    CMD_LC_AnimalAdminQueryName = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_AnimalAdminQueryName),
    CMD_LC_AnimalAdminQueryAllJetton = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_AnimalAdminQueryAllJetton),
    CMD_LC_AnimalAdminQueryPlayerJetton = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_AnimalAdminQueryPlayerJetton),
    CMD_CL_CarAdmin = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_CarAdmin),
    CMD_LC_CarAdmin = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_CarAdmin),
    CMD_LC_CarAdminQueryName = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_CarAdminQueryName),
    CMD_LC_CarAdminQueryAllJetton = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_CarAdminQueryAllJetton),
    CMD_LC_CarAdminQueryPlayerJetton = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.LC_Sub_CarAdminQueryPlayerJetton),
    CMD_CL_ChangeUserGold = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_ChangeUserGold),
    CMD_CL_ChangeTablePool = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_Sub_ChangeTablePool),

    //更新充值
   
    CMD_CL_QRoleDaili = (int)(MainCmdType.CMD_MAIN_Control << 8) | (int)(LOCAL_SubControl.CL_QRoleDaili),


    CMD_LC_QueryFishPoolResult = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_QueryFishPoolResult),//查询库存
    CMD_LC_QueryOnlineUserInfoRol = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_QueryOnlineUserInfoRol),
    CMD_LC_QueryBlackListResultRol = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_QueryBlackListResultRol),
    CMD_LC_SetBlackListResultRol = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_SetBlackListResultRol),
    CMD_LC_CheckRoleUserDailiBond = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_CheckRoleUserDailiBond),
    CMD_LC_RoleUserDailiBondResult = (int)(MainCmdType.CMD_MAIN_Role << 8) | (int)(Role_SubCmd.LC_Sub_RoleUserDailiBondResult),
    ...
    CMD_CL_ShopGoldItem                 = (int)(MainCmdType.CMD_MAIN_Shop << 8) | (int)(Shop_SubCmd.CL_Sub_ShopGoldItem),
    //实体
   ...
   CMD_LC_RoleBeLeaveVipSeat    = (int)(MainCmdType.CMD_Main_NiuNiu << 8) | (int)(NiuNiu_SubCmd.LC_Sub_RoleBeLeaveVipSeat),
    ...
    CMD_LC_AnimalAdminContrlBack = (int)(MainCmdType.CMD_Main_Dial << 8) | (int)(Dial_SubCmd.LC_Sub_AnimalAdminContrlBack),
    CMD_LC_AnimalAdminQueryNameContrl = (int)(MainCmdType.CMD_Main_Dial << 8) | (int)(Dial_SubCmd.LC_Sub_AnimalAdminQueryNameContrl),
    CMD_LC_AnimalAdminQueryAllJettonContrl = (int)(MainCmdType.CMD_Main_Dial << 8) | (int)(Dial_SubCmd.LC_Sub_AnimalAdminQueryAllJettonContrl),
    CMD_LC_AnimalAdminQueryPlayerJettonContrl = (int)(MainCmdType.CMD_Main_Dial << 8) | (int)(Dial_SubCmd.LC_Sub_AnimalAdminQueryPlayerJettonContrl),
...
public class NetCmdMapping
{
    ...
    static public bool GlobalInit()
    {
        ...
        bRet &= InitCmdTypeInfo<LC_Cmd_TableChangeRoleGlobeDown>    (NetCmdType.CMD_LC_TableChangeRoleGlobeDown );
       ...
       // bRet &= InitCmdTypeInfo<CL_Cmd_ChangeUserRelation>(NetCmdType.CMD_CL_ChangeUserRelation);
        ...
        bRet &= InitCmdTypeInfo<LC_Cmd_ChangeRoleGlobeDown>(NetCmdType.CMD_LC_ChangeRoleGlobeDown);
       ...
       // bRet &= InitCmdTypeInfo<CL_Cmd_GetMonthRoleSum>(NetCmdType.CMD_CL_GetMonthRoleSum);
        ...
        bRet &= InitCmdTypeInfo<Cl_Cmd_ShopGoldItem>(NetCmdType.CMD_CL_ShopGoldItem);
        //Entity
       ...
       // bRet &= InitCmdTypeInfo<CL_Cmd_ChangeRoleEntityID>(NetCmdType.CMD_CL_ChangeRoleEntityID);
        ...
        bRet &= InitCmdTypeInfo<LC_Cmd_AnimalAdminContrlBack>(NetCmdType.CMD_LC_AnimalAdminContrlBack);
        bRet &= InitCmdTypeInfo<LC_Cmd_AnimalAdminQueryNameContrl>(NetCmdType.CMD_LC_AnimalAdminQueryNameContrl);
        bRet &= InitCmdTypeInfo<LC_Cmd_AnimalAdminQueryAllJettonContrl>(NetCmdType.CMD_LC_AnimalAdminQueryAllJettonContrl);
        bRet &= InitCmdTypeInfo<LC_Cmd_AnimalAdminQueryPlayerJettonContrl>(NetCmdType.CMD_LC_AnimalAdminQueryPlayerJettonContrl);
        ...
        //控制
        bRet &= InitCmdTypeInfo<CL_Cmd_CheckClientInfo>(NetCmdType.CMD_CL_CheckClientInfo);
        bRet &= InitCmdTypeInfo<LC_Cmd_CheckClientInfo>(NetCmdType.CMD_LC_ChangeRoleUserDailito);
        bRet &= InitCmdTypeInfo<LC_Cmd_ChangeRoleGlobeSuccess>(NetCmdType.CMD_LC_ChangeRoleGlobeSuccess);



        bRet &= InitCmdTypeInfo<CL_Cmd_SendMsgToAllGame>(NetCmdType.CMD_CL_SendMsgToAllGame);
        bRet &= InitCmdTypeInfo<CL_Cmd_KickUserByID>(NetCmdType.CMD_CL_KickUserByID);
        bRet &= InitCmdTypeInfo<LC_Cmd_KickUserResult>(NetCmdType.CMD_LC_KickUserResult);
        bRet &= InitCmdTypeInfo<CL_Cmd_ReloadConfig>(NetCmdType.CMD_CL_ReloadConfig);
        bRet &= InitCmdTypeInfo<CL_Cmd_HandleGailv>(NetCmdType.CMD_CL_HandleGailv);
        bRet &= InitCmdTypeInfo<CL_Cmd_CheckClientDailiBond>(NetCmdType.CMD_CL_CheckClientDailiBond);
        bRet &= InitCmdTypeInfo<CL_Cmd_ClientDailiBond>(NetCmdType.CMD_CL_ClientDailiBond);
        bRet &= InitCmdTypeInfo<CL_Cmd_HandleEntityItem>(NetCmdType.CMD_CL_HandleEntityItem);
        bRet &= InitCmdTypeInfo<LC_Cmd_HandleEntityItem>(NetCmdType.CMD_LC_HandleEntityItem);
        bRet &= InitCmdTypeInfo<CL_Cmd_ResetRolePassword>(NetCmdType.CMD_CL_ResetRolePassword);
        bRet &= InitCmdTypeInfo<CL_Cmd_FreezeAccount>(NetCmdType.CMD_CL_FreezeAccount);
        bRet &= InitCmdTypeInfo<CL_Cmd_SendSystemEmail>(NetCmdType.CMD_CL_SendSystemEmail);
        bRet &= InitCmdTypeInfo<CL_Cmd_ChangeaNickName>(NetCmdType.CMD_CL_ChangeaNickName);
        bRet &= InitCmdTypeInfo<CL_Cmd_QueryOnlineUserInfo>(NetCmdType.CMD_CL_QueryOnlineUserInfo);
        bRet &= InitCmdTypeInfo<LC_Cmd_QueryOnlineUserInfo>(NetCmdType.CMD_LC_QueryOnlineUserInfo);
        bRet &= InitCmdTypeInfo<CL_Cmd_ChangeParticularStates>(NetCmdType.CMD_CL_ChangeParticularStates);
        bRet &= InitCmdTypeInfo<LC_Cmd_ChangeParticularStates>(NetCmdType.CMD_LC_ChangeParticularStates);
        bRet &= InitCmdTypeInfo<LC_Cmd_CenterInfo>(NetCmdType.CMD_LC_CenterInfo);
        bRet &= InitCmdTypeInfo<LC_Cmd_GameInfo>(NetCmdType.CMD_LC_GameInfo);
        bRet &= InitCmdTypeInfo<LC_Cmd_LogonInfo>(NetCmdType.CMD_LC_LogonInfo);
        bRet &= InitCmdTypeInfo<LC_Cmd_DBInfod>(NetCmdType.CMD_LC_DBInfod);
        bRet &= InitCmdTypeInfo<LC_Cmd_RankInfo>(NetCmdType.CMD_LC_RankInfo);
        bRet &= InitCmdTypeInfo<LC_Cmd_FTPInfo>(NetCmdType.CMD_LC_FTPInfo);
        bRet &= InitCmdTypeInfo<LC_Cmd_OperateInfo>(NetCmdType.CMD_LC_OperateInfo);
        bRet &= InitCmdTypeInfo<LC_Cmd_MiNiGameInfo>(NetCmdType.CMD_LC_MiNiGameInfo);
        bRet &= InitCmdTypeInfo<CL_Cmd_QueryFishPool>(NetCmdType.CMD_CL_QueryFishPool);
        //更新
        bRet &= InitCmdTypeInfo<CL_Cmd_HandleTablePoolGailv>(NetCmdType.Cmd_CL_HandleTablePoolGailv);

        bRet &= InitCmdTypeInfo<LC_Cmd_QueryFishPoolResult>(NetCmdType.CMD_LC_QueryFishPoolResult);

        bRet &= InitCmdTypeInfo<LC_Cmd_QueryOnlineUserInfoRol>(NetCmdType.CMD_LC_QueryOnlineUserInfoRol);
        bRet &= InitCmdTypeInfo<LC_Cmd_QueryBlackListResultRol>(NetCmdType.CMD_LC_QueryBlackListResultRol);
        bRet &= InitCmdTypeInfo<LC_Cmd_SetBlackListResultRol>(NetCmdType.CMD_LC_SetBlackListResultRol);
        bRet &= InitCmdTypeInfo<LC_Cmd_CheckRoleUserDailiBond>(NetCmdType.CMD_LC_CheckRoleUserDailiBond);
        bRet &= InitCmdTypeInfo<LC_Cmd_RoleUserDailiBondResult>(NetCmdType.CMD_LC_RoleUserDailiBondResult);
        bRet &= InitCmdTypeInfo<CL_Cmd_QueryBlackList>(NetCmdType.CMD_CL_QueryBlackList);
        bRet &= InitCmdTypeInfo<LC_Cmd_QueryBlackListResult>(NetCmdType.CMD_LC_QueryBlackListResult);
        bRet &= InitCmdTypeInfo<CL_Cmd_SetBlackList>(NetCmdType.CMD_CL_SetBlackList);
        bRet &= InitCmdTypeInfo<LC_Cmd_SetBlackListResult>(NetCmdType.CMD_LC_SetBlackListResult);
        bRet &= InitCmdTypeInfo<CL_Cmd_OxAdmin>(NetCmdType.CMD_CL_OxAdmin);
        bRet &= InitCmdTypeInfo<LC_Cmd_OxAdmin>(NetCmdType.CMD_LC_OxAdmin);
        bRet &= InitCmdTypeInfo<LC_Cmd_OxAdminQueryName>(NetCmdType.CMD_LC_OxAdminQueryName);
        bRet &= InitCmdTypeInfo<LC_Cmd_OxAdminQueryAllJetton>(NetCmdType.CMD_LC_OxAdminQueryAllJetton);
        bRet &= InitCmdTypeInfo<LC_Cmd_OxAdminQueryPlayerJetton>(NetCmdType.CMD_LC_OxAdminQueryPlayerJetton);
        bRet &= InitCmdTypeInfo<CL_Cmd_AnimalAdmin>(NetCmdType.CMD_CL_AnimalAdmin);
        bRet &= InitCmdTypeInfo<LC_Cmd_AnimalAdmin>(NetCmdType.CMD_LC_AnimalAdmin);
        bRet &= InitCmdTypeInfo<LC_Cmd_AnimalAdminQueryName>(NetCmdType.CMD_LC_AnimalAdminQueryName);
        bRet &= InitCmdTypeInfo<LC_Cmd_AnimalAdminQueryAllJetton>(NetCmdType.CMD_LC_AnimalAdminQueryAllJetton);
        bRet &= InitCmdTypeInfo<LC_Cmd_AnimalAdminQueryPlayerJetton>(NetCmdType.CMD_LC_AnimalAdminQueryPlayerJetton);
        bRet &= InitCmdTypeInfo<CL_Cmd_CarAdmin>(NetCmdType.CMD_CL_CarAdmin);
        bRet &= InitCmdTypeInfo<LC_Cmd_CarAdmin>(NetCmdType.CMD_LC_CarAdmin);
        bRet &= InitCmdTypeInfo<LC_Cmd_CarAdminQueryName>(NetCmdType.CMD_LC_CarAdminQueryName);
        bRet &= InitCmdTypeInfo<LC_Cmd_CarAdminQueryAllJetton>(NetCmdType.CMD_LC_CarAdminQueryAllJetton);
        bRet &= InitCmdTypeInfo<LC_Cmd_CarAdminQueryPlayerJetton>(NetCmdType.CMD_LC_CarAdminQueryPlayerJetton);
        bRet &= InitCmdTypeInfo<CL_Cmd_ChangeUserGold>(NetCmdType.CMD_CL_ChangeUserGold);
        bRet &= InitCmdTypeInfo<CL_Cmd_ChangeTablePool>(NetCmdType.CMD_CL_ChangeTablePool);

        //更新充值
        bRet &= InitCmdTypeInfo<CL_Cmd_QRoleDaili>(NetCmdType.CMD_CL_QRoleDaili);
        bRet &= InitCmdTypeInfo<LC_Cmd_GetRoleDaili>(NetCmdType.CMD_LC_GetRoleDaili);
       // bRet &= InitCmdTypeInfo<LC_Cmd_ChangeRoleGlobeSuccess>(NetCmdType.CMD_LC_ChangeRoleGlobeSuccess);
